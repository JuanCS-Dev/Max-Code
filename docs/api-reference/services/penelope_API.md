# PENELOPE - API Reference

**Gerado:** 2025-11-07 20:46:01
...
### `test_praotes_validator.py` - Line 119
```python
...
### `test_praotes_validator.py` - Line 122
```python
...
### `test_praotes_validator.py` - Line 297
```python
...
- `def suggest_improvements(self, patch`

---

### `SophiaEngine`

**File:** `sophia_engine.py`
...
**File:** `tapeinophrosyne_monitor.py`
...
- `def generate_uncertainty_report(self, patch`
